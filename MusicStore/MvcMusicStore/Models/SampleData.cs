...
namespace MvcMusicStore.Models
{
    public class SampleData
    {
        public void Seed(MusicStoreEntities context)
        {
            ...
            context.Database.ExecuteSqlCommand("DELETE [dbo].[Artists]");
            context.Database.ExecuteSqlCommand("DELETE [dbo].[Albums]");
            context.Database.ExecuteSqlCommand("DELETE [dbo].[Genres]");

            context.Database.ExecuteSqlCommand("DBCC CHECKIDENT ('[dbo].[Artists]', RESEED, 0)");
            context.Database.ExecuteSqlCommand("DBCC CHECKIDENT ('[dbo].[Albums]', RESEED, 0)");
            context.Database.ExecuteSqlCommand("DBCC CHECKIDENT ('[dbo].[Genres]', RESEED, 0)");
